...
class ExtraCheese extends ToppingDecorator {
    ...
    getPrice() { return this._food.getPrice() + 10000; }
...
class ExtraSauce extends ToppingDecorator {
    ...
    getPrice() { return this._food.getPrice() + 5000; }
...
class ExtraMeat extends ToppingDecorator {
    ...
    getPrice() { return this._food.getPrice() + 20000; }
...
class ExtraVeggies extends ToppingDecorator {
    ...
    getPrice() { return this._food.getPrice() + 8000; }
